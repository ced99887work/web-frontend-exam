...
const handleBocyMouseMove = (e: MouseEvent) => {
...
const Background = () => {
  ...
  return (
    <Box className="home-background">
      ...
      {/* 左眼 */}
      <img
        className="home-layer layer-character-left-eye-container"
        src="/images/home/left-eye-container.png"
        alt="character left eye container"
      />
      {/* 右眼 */}
      <img
        className="home-layer layer-character-right-eye-container"
      ...
      {/* logo */}
      <img
        className="home-layer layer-logo"
